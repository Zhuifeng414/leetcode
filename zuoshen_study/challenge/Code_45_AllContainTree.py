...
class Node(object):
    ...
    def isSubTree(self, t1, t2):
        t1Str = self.serialByPre(t1)
        t2Str = self.serialByPre(t2)
        print(t1Str)
        print(t2Str)
...
if __name__ == '__main__':
    ...
    print('================>>>')
    # print(Node().contains(head, pd))
    # s = 'acbc'
    #     # m = 'bc'
    #     # print(KMP().getIndexOf(s, m))
    #print(Node().serialByPre(pd))
    print(Node().isSubTree(head, pd))